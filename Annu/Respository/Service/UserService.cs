...
using Annu.Respository.Contract;
...
namespace Annu.Respository.Service
{
    public class UserService : IUser
    {
        ...
        private void SendMail(string to, string Otp)
        {
            ...
            smtp.Credentials = new System.Net.NetworkCredential("abhishek17rockss@gmail.com", "abhi17yadav"); // Enter senders User name and password  
            smtp.EnableSsl = true;
            smtp.Send(mail);
